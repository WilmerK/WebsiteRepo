    ...
    <div class="content-container">
        ...
        <?php if (!$isOwnPage): ?>
            <form action="follow.php" method="POST">
                ...
                <button type="submit" class="create-post-btn" style="<?php echo $isFollowing ? "background-color: #888;" : "background-color: #FF4500;"?>">
                    ...
                    <div class="post-actions" data-post-id="<?php echo $post['id']; ?>">
                        <form action="vote.php" method="POST">
                            ...
                            <button class="vote-btn upvote">
                                <span class="material-symbols-outlined <?php echo $userVote === 1 ? 'active-vote' : ''; ?>">arrow_upward</span>
                            </button>
                        </form>
                        ...
                        <form action="vote.php" method="POST">
                            ...
                            <button class="vote-btn downvote">
                                <span class="material-symbols-outlined <?php echo $userVote === -1 ? 'active-vote' : ''; ?>">arrow_downward</span>
                            </button>
                        </form>
                        ...
                        <button type="button" class="share-button" data-post-id="<?php echo $post['id']; ?>" title="Copy share link">
